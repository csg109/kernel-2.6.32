...
/* filesystem information */
	struct fs_struct *fs; 		/* 文件系统相关数据，包含当前工作目录和chroot限制有关的信息 */
/* open file information */
	struct files_struct *files; 	/* 当前进程的各个文件描述符 */
/* namespaces */
...
/* signal handlers */
	...
	sigset_t blocked, real_blocked; /* blocked表示当前进程中哪些信号被阻塞 */
	sigset_t saved_sigmask;	/* restored if set_restore_sigmask() was used */
	struct sigpending pending; /* 可以看作进程的信号队列，它存放所有未决的信号 */
...
/* journalling filesystem info */
	void *journal_info; 	/* jbd中指向当前进程的handle_t */

/* stacked block device info */
	struct bio *bio_list, **bio_tail; /* 递归调用累积的块设备信息 */
